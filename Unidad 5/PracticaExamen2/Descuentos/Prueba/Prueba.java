...
public class Prueba {
    public static void main (String [] args) {
        ...
        PruebaEscritor escritor = new PruebaEscritor();
        PruebaLector lector = new PruebaLector();

       continua =  escritor.escribir("Desea comenzar? si/no");
        ...
        while(continuaProgra) {
            precioInicial = escritor.escribir("Indique el precio del articulo comprado");
