...
public class Narrador {
	...
	public int menuInicio() {
		return escritor.mostrarEntradaInt("Inicia tu aventura!!  \n1.Iniciar \n2.Salir");
	}
	...
	public int menuTienda(Tienda tienda, Protagonista prota) {
		return escritor.mostrarEntradaInt(
	...
	public String nombreProta() {
		return escritor.mostrarEntradaStr("Indique el nombre de su protagonista");
	}

	public String nombreAtaque() {
		return escritor.mostrarEntradaStr("Indique el nombre del ataque del protagonista");
	}
	...
	public int menuPrincipal() {
		return escritor.mostrarEntradaInt("Elige tu camino en esta aventura \n 1.Explorar" + "\n 2.Estado "
				+ "\n 3.Tienda " + "\n 4.Salir del juego");
	}
	...
	public int subMenu(Enemigo enemigo) {
		return escritor.mostrarEntradaInt("Tu enemigo es: " + enemigo.getNombre()
				+ "\nElija una opcion: \n 1.Luchar \n 2.Correr \n 3.Tienda \n 4.Botiquin");
	}
